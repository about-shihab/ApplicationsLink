CREATE OR REPLACE PACKAGE pkg_apps_link
  ...
  PROCEDURE fsp_set_link_catg
            ...
            , pcolor1          IN sebl_link_catg.color1%Type
            , pcolor2          IN sebl_link_catg.color2%Type
...
CREATE OR REPLACE PACKAGE BODY pkg_apps_link
  ...
  BEGIN
    SELECT COUNT(1)
     ...
     WHERE t.catg_name = pcatg_name;
     
     IF v_count>0 THEN
       UPDATE sebl_link_catg t
          SET t.color1 = pcolor1
            , t.color2 = pcolor2
            , t.make_by = pmake_by
            , t.make_dt = SYSDATE
        WHERE t.catg_name = pcatg_name;
     ELSE
       ...
       INSERT INTO sebl_link_catg
         (catg_id, catg_name, color1, color2, make_by, make_dt)
       VALUES
         (v_max_catg_id, pcatg_name, pcolor1, pcolor2, pmake_by, SYSDATE);
     END IF;  
